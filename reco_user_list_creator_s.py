...
def main():
    ...
    # bxu updates - added
    dh_demo_all = load_demo2(spark, path_demo, sepr, cols_demo)
    # generate reco user lists
    # bxu updates - create secialty list
    all_user_list = make_unique_col_list(dh_demo, user_id)
    # bxu updates - added
    all_user_list_all = make_unique_col_list(dh_demo_all, user_id)
    # bxu updates
    # commented
    ...
    # bxu updates
    # Do this function work????
    # bxu updates - non-specialty list
    ...
    # bxu updates - commented
    # save_list_as_pickle(speciality_reco_user_list, path_speciality_reco_user_list)
    # bxu updates - added
    save_list_as_pickle(all_user_list_all, path_speciality_reco_user_list_all)
    save_list_as_pickle(all_user_list, path_speciality_reco_user_list_s)
    save_list_as_pickle(non_specialty_user_list, path_non_specialty_user_list_s)
