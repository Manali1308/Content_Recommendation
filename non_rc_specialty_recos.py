...
def main():
    ...
    specialty_reco = non_rc_specialty_recommendations(spark, dh_activity, dh_demo, relevant_urlid,
    ...
    user_missed_in_specialty = find_specialty_missed_users(spark, path_speciality_reco_user_list,
                                                           temp_path_for_specialty_reco)
    ...
    non_specialty_recos.to_csv(temp_path_non_specialty_recos, sep=sepr_recos, index=False, header=False,
                               append_mode=False)
